...
export const projects: Project[] = [
  ...
  type: "AI Commercial",
  description:
  "An AI-powered hair-care commercial for Mamaearth, following a relatable scalp-care story where a brand character introduces the product as a solution. Created with AI-generated visuals, character animation and cinematic video editing.",
  thumbnail: "/images/ai-ad-03-cover.jpg",
  video: "/videos/ai-ad-03.mp4",
  orientation: "portrait",
  year: "2026",
  role: "AI content + video editing",
  tools: [],
  ...
  {
  id: "bridal-beauty-film",
  title: "Bridal Beauty Film",
  category: "COMMERCIAL EDITING",
  type: "Bridal Edit",
  description:
    "An elegant bridal beauty edit featuring refined visuals, smooth transitions and cinematic pacing to create a premium bridal presentation.",
  thumbnail: "/images/Bridal-cover.jpg",
  video: "/videos/Bridal-edit.mp4",
  orientation: "portrait",
  year: "2026",
  role: "Video editing",
  tools: [],
